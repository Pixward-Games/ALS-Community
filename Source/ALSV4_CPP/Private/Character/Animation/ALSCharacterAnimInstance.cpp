...
void UALSCharacterAnimInstance::UpdateAimingValues(float DeltaSeconds)
{
	...
	if (!RotationMode.VelocityDirection())
	{
		...
		AimingValues.AimSweepTime = FMath::GetMappedRangeValueClamped(FVector2d{-90.0f, 90.0f}, FVector2d{1.0f, 0.0f},
	...
	AimingValues.LeftYawTime = FMath::GetMappedRangeValueClamped(FVector2d{0.0f, 180.0f}, FVector2d{0.5f, 0.0f},
	                                                             FMath::Abs(SmoothedAimingAngle.X));
	AimingValues.RightYawTime = FMath::GetMappedRangeValueClamped(FVector2d{0.0f, 180.0f}, FVector2d{0.5f, 1.0f},
	                                                              FMath::Abs(SmoothedAimingAngle.X));
	AimingValues.ForwardYawTime = FMath::GetMappedRangeValueClamped(FVector2d{-180.0f, 180.0f}, FVector2d{0.0f, 1.0f},
...
void UALSCharacterAnimInstance::UpdateRagdollValues()
{
	...
	FlailRate = FMath::GetMappedRangeValueClamped(FVector2d{0.0f, 1000.0f}, {0.0f, 1.0f}, VelocityLength);
}
...
{
	InAir.bJumped = true;
	InAir.JumpPlayRate = FMath::GetMappedRangeValueClamped(FVector2d{0.0f, 600.0f}, {1.2f, 1.5f}, CharacterInformation.Speed);
